...
export default function WardenQueriesPage() {
    ...
    const fetchQueries = async () => {
        try {
            const [pending, resolved] = await Promise.all([
                api.getWardenPendingQueries(),
                api.getWardenResolvedQueries()
            ]);
        ...
        <div className="min-h-screen space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-500 mt-1">Respond to queries from hostel students</p>
                </div>
                <div className="flex items-center gap-3">
                    ...
                    <div className="bg-gradient-to-br from-green-900/40 to-green-950/60 border border-green-700/40 rounded-xl px-4 py-2.5 flex items-center gap-2">
                        ...
                        <span className="text-green-400 text-xs uppercase tracking-wider">Resolved</span>
                    </div>
                </div>
            </div>
                ...
                <div className="bg-slate-800/30 border border-dashed border-slate-700 rounded-xl p-16 text-center relative overflow-hidden">
                    ...
                    {activeTab === 'pending' ? (
                        <>
                            ...
                            <p className="text-slate-500">No pending queries from hostellers</p>
                        </>
                    ) : (
                        <>
                            <ClockCounterClockwise size={64} weight="duotone" className="text-slate-600 mx-auto mb-4" />
                            <h3 className="text-xl font-bold text-slate-400 mb-2 uppercase tracking-wider">No History Yet</h3>
                    ...
                    <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-2xl shadow-2xl">
                        ...
                        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-700">
                            <div className="flex items-center gap-3">
                                ...
                                <h3 className="text-lg font-chivo font-bold uppercase tracking-wider">Respond to Query</h3>
                            </div>
                            <button
                            ...
                            <div>
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    <button
                                        ...
                                        disabled={generating}
                                        className="flex items-center gap-2 text-sm bg-purple-900/50 hover:bg-purple-900/70 text-purple-300 px-3 py-1.5 rounded-lg transition-colors disabled:opacity-50"
                                    >
                                        {generating ? (
                                            <>
                        ...
                        <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-slate-700">
                            ...
                            <button
                                ...
                                className="px-6 py-2 bg-green-600 hover:bg-green-500 text-white rounded-lg disabled:opacity-50 flex items-center gap-2 transition-colors"
                            >
                                {submitting ? (
                                    <>
